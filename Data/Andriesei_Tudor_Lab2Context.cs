...
namespace Andriesei_Tudor_Lab2.Data
{
    public class Andriesei_Tudor_Lab2Context : DbContext
    {
        ...
        public DbSet<Andriesei_Tudor_Lab2.Models.Author>Author { get; set; }

        public DbSet<Andriesei_Tudor_Lab2.Models.Member> Member { get; set; }

        public DbSet<Andriesei_Tudor_Lab2.Models.Borrowing> Borrowing { get; set; }
    }
}
